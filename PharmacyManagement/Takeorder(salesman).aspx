<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Takeorder(salesman).aspx.cs" Inherits="PharmacyManagement.Takeorder_salesman_" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 ...
 <div class="clr">
        ...
        <div class ="LoginPage">
        <asp:Label ID="welcome" runat="server" Text="Take Order"></asp:Label>
        </div>
        </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="login">
         ...
         <div class="post-data">Customer Name <input class="inputfield" type="text" name="firstname1" size="20"></div>                     
